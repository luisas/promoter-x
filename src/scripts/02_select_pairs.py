...
mmseqs_search_output = "./data/promoters/promoters_clustering.m8"
exec = "mmseqs easy-search "+ path_promoters_sample_1 +" "+ promoters_path+" "+mmseqs_search_output+" tmp --search-type 3"
os.system(exec)
...
similar_promoters = pd.read_csv(mmseqs_search_output, sep="\t", header=None)
# extract promoters from column 1
promoters_ids = similar_promoters[1].unique()
promoters_ids
...
seq_id.to_csv("./data/promoters/promoter_pairs_test.csv", index=False)
seq_id
